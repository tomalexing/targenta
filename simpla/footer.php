...
<div class="contacts" id="contacts">
	<div class="contacts__title">
		<h2><?php echo get_the_title(133); ?></h2>
	</div>
			...
			<div class="vertical-line"></div>
			 <form role="form" id="formOrder" autocomplete="on">
				<div class="contact__input">
					...
					<label><?php _e('Name*', 'targenta') ?></label>
				</div>
				<div class="contact__input">
					<input type="text" class="form-control requiredField email" value="">
					<span class="highlight"></span><span class="bar"></span>
					<label><?php _e('E-mail*', 'targenta') ?></label>
				</div>
				<div class="contact__input">
					<input type="text" class="form-control requiredField phone" value="">
					<span class="highlight"></span><span class="bar"></span>
					<label><?php _e('Phone*', 'targenta') ?></label>
				</div>
				<div class="contact__input">
					<input type="text" class="form-control message" value="">
					<span class="highlight"></span><span class="bar"></span>
					<label><?php _e('Message', 'targenta') ?></label>
				</div>
				<button type="button" class="start__submit">
					<?php _e('Ask a Question', 'targenta') ?>
	...
	<div class="footer l">
		...
		<div class="copyright l-col2">
			<p>© <?php _e('All rights reserved.', 'targenta') ?></p>
